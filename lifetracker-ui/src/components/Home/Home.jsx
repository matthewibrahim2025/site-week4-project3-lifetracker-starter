...
const Home = () => {
  return (
    <div class="css-16ecvb5">
      <div class="css-1561uet">
        <div class="chakra-stack css-18rb735">
          <h1 class="chakra-heading css-bgad6s">LifeTracker</h1>
          <h2 class="chakra-heading css-1la3ewl">
            Helping you take back control of your world.
          </h2>
          <a href="/signup">
            <button type="button" class="chakra-button css-uybm84">
              Create your account now
            </button>
          </a>
        </div>
        <div id="tracker-pic" class="css-jocq0n">
          {/* <img
            src="../src/assets/tracker.jpg"
            class="chakra-image css-incex5"
          /> */}
        </div>
      </div>
      <div class="tiles css-gg4vpm">
        <div spacing="10px" class="css-dvxtzn">
          <div class="css-70qvj9">
            <p class="chakra-text css-1jijfcn">Fitness</p>
        ...
        <div spacing="10px" class="css-dvxtzn">
          <div class="css-70qvj9">
            <p class="chakra-text css-1jijfcn">Food</p>
            <div class="css-17xejub"></div>&nbsp;
            <svg
              stroke="currentColor"
              fill="currentColor"
        ...
        <div spacing="10px" class="css-dvxtzn">
          <div class="css-70qvj9">
            <p class="chakra-text css-1jijfcn">Rest</p>
            <div class="css-17xejub"></div>&nbsp;
            <svg
              stroke="currentColor"
              fill="currentColor"
        ...
        <div spacing="10px" class="css-dvxtzn">
          <div class="css-70qvj9">
            <p class="chakra-text css-1jijfcn">Planner</p>
            <div class="css-17xejub"></div>&nbsp;
            <svg
              stroke="currentColor"
              fill="currentColor"
