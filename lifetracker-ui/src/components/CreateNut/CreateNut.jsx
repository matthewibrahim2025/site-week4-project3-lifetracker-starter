  ...
  const handleAddData = async (
    ...
    try {
      ...
      const res = await axios.post(
        `https://lifetracker-backend-4wt1.onrender.com/auth/nutrition`,
        {
          name: name,
          category: category,
          quantity: quantity,
  ...
  return (
    <div class="addNutritionalData">
      ...
      <form
        class="formContainer"
        onSubmit={(event) =>
          handleAddData(event, name, category, quantity, calories, id, imageurl)
        }
      >
        ...
        <div class="inputGroup">
          ...
          <div class="caloriesControls">
            <button type="button" onClick={handleCaloriesDecrement}>
              -
            </button>
            <input
              type="number"
            ...
            />
            <button type="button" onClick={handleCaloriesIncrement}>
              +
            </button>
          </div>
        </div>
